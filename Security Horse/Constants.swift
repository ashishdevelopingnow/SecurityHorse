...
//  Security Horse
//
//  Created by Kuldeep Butola on 28/01/17.
...
struct Constants {
    ...
    static let APP_NAME = "Security Horse"
    ...
    static let SUB_TITLE_MOBILE_VERIFY = "SecurityHorse profiles with verified numbers are 3x more likely to get hired."
     ...
     static let ALERT_FULL_NAME = "Please enter full name"
     static let ALER_PHONENUMBER = "Please enter phone number"
}
